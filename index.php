            ...
            <div class="row">
                <div class="col-12">
                    <?php
                        ...
                        $harrypotter2 = new Movie ("Harry potter e la camera dei segreti", "2002", "fantasy");
                        $harrypotter3 = new Movie ("Harry potter e il prigioniero di Azkabanm", "2004", "fantasy");
                        $harrypotter4 = new Movie ("Harry potter e il calice di fuoco", "2005", "fantasy");
                        $harrypotter5 = new Movie ("Harry potter e l'ordine della fenice", "2007", "fantasy");
                        $harrypotter6 = new Movie ("Harry potter e il principe mezzo-sangue", "2009", "fantasy");
                        $harrypotter7parte1 = new Movie ("Harry potter e i doni della morte: Parte 1", "2010", "fantasy");
                        $harrypotter7parte2 = new Movie ("Harry potter e i doni della morte: Parte 2", "2011", "fantasy");
